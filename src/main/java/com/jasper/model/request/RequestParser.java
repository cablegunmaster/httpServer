        ...
        switch (request.getState()) {
            ...
            case READ_URI:
                if (hasSpace()) {
                    ...
                    request.getStateBuilder().append(c);
                    request.getStateUrlBuilder().append(c);
                    readUri(request);
                }
                break;
            case READ_HTTP:
...
//
    ...
    private boolean hasForwardSlashInBuilder() {
        return request.getStateUrlBuilder().toString().startsWith("/");
    }
